...
def buildFeatureStatement(tree):
    ...
    namesList = core.resolveObjectFOPC(subject)
    ...
    core.findAndAttachPrepObjectsFOPC(root, subject, namesList)
    ...
    core.findAndAssertFeaturesFOPC(root, namesList)
    
    ##### Your code to findAndAssertDefinitionsFOPC -- this takes the root and your names
    
    
    core.findAndAssertDefinitionsFOPC(root, namesList)
